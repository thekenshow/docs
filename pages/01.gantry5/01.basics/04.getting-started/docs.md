...
Accessing the Gantry 5 administrator in Grav is easy. Simply log in to the Grav Admin under an account with <code>admin.super</code> or <code>admin.themes</code> permission, and select **Gantry 5** in the sidebar. Once here, you can choose the Gantry 5 theme you wish to configure by clicking the **Configure** button. 
